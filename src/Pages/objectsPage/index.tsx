  ...
  const tbody = [
    {
      id: '222319333223232',
      num: 1,
      adr: '612260, обл Кировская, р-н Яранский, г Яранск, ул Строительная, д. 9',
      sq: '4589,56',
      year: 1985,
    },
    {
      id: '112309723192323',
      num: 2,
      adr: '612260, обл Кировская, р-н Яранский, г Яранск, ул Производственная, д. 13',
      sq: '1284,71',
      year: 1991,
    },
  ];
        ...
        <PageTable thead={thead}>
          {tbody.map((body) => (
            <tr key={body.id} className="bg-white border-b-2 border-bg hover:bg-bg ">
              ...
              <td className="px-6 py-4">{body.sq}</td>
